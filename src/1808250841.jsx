            ...
            return (
              <div key={idx} className="flip-card h-56 overflow-hidden">
                <div className="flip-card-inner relative w-full h-full rounded-xl shadow-lg">
                  {/* Front Side */}
                  <div className={`flip-card-front absolute inset-0 flex flex-col justify-center items-center bg-gradient-to-br ${service.gradient} text-white rounded-xl p-6`}>
                    <Icon size={36} className="mb-3" />
                    <h3 className="text-lg font-bold text-center">{service.title}</h3>
                  </div>
                  {/* Back Side */}
                  <div className="flip-card-back absolute inset-0 flex flex-col justify-center items-center bg-white text-gray-800 rounded-xl p-6">
