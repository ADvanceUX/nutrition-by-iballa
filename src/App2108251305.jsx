...
>
  ...
  <div className="relative z-10 flex flex-col md:flex-row-reverse max-w-7xl mx-auto px-6 md:px-12">
    
    {/* Right Half: Background Image */}
    <div
      className="w-full md:w-1/2 h-[500px] md:h-auto bg-no-repeat bg-contain bg-right bg-center"
      style={{
        backgroundImage: "url('/banner1.png')",
      }}
    ></div>

    {/* Left Half: Appointment Content */}
          ...
          <form className="max-w-2xl mx-auto w-full" onSubmit={handleSubmit}>
            <table className="w-full text-left text-white">
              <tbody>
                ...
                {/* Email */}
                <tr className="align-top pb-6">
                  <td className="w-32 md:w-40 pr-4 py-2 font-display text-sm font-medium text-left whitespace-nowrap">{t("contact.fields.email")}</td>
                  <td className="w-full">
                    <input
                      id="email"
                      name="email"
